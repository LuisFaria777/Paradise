...
class PaymentMethod(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='payment_user', on_delete=models.PROTECT)
...
class Transaction(models.Model):
    ...
    receiver = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='receiver', on_delete=models.PROTECT, default='')
    creator = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='creator', on_delete=models.PROTECT, default='')
